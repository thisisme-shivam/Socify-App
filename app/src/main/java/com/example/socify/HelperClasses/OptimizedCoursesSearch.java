...
public class OptimizedCoursesSearch {
    ...
    public OptimizedCoursesSearch(CoursesFragment coursesFragment){
        ...
        th =new Thread(new Runnable() {
            ...
            public void run() {
                for(Course course : filterlist ){
                    ...
                    if(OptimizedCollegeSearch.check(keywords,collegewords) == keywords.length)
